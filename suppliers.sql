            ...
            UPDATE products  SET suppliers_id=1  WHERE product_name='Chang';
            UPDATE products  SET suppliers_id=1  WHERE product_name='Aniseed Syrup';
            UPDATE products  SET suppliers_id=2  WHERE product_name='Chef Anton''s Cajun Seasoning';
            UPDATE products  SET suppliers_id=2  WHERE product_name='Chef Anton''s Gumbo Mix';
            UPDATE products  SET suppliers_id=2  WHERE product_name='Louisiana Fiery Hot Pepper Sauce';
            UPDATE products  SET suppliers_id=2  WHERE product_name='Louisiana Hot Spiced Okra';
            UPDATE products  SET suppliers_id=3  WHERE product_name='Grandma''s Boysenberry Spread';
            UPDATE products  SET suppliers_id=3  WHERE product_name='Uncle Bob''s Organic Dried Pears';
            UPDATE products  SET suppliers_id=3  WHERE product_name='Northwoods Cranberry Sauce';
            UPDATE products  SET suppliers_id=4  WHERE product_name='Mishi Kobe Niku';
            UPDATE products  SET suppliers_id=4  WHERE product_name='Ikura';
            UPDATE products  SET suppliers_id=4  WHERE product_name='Longlife Tofu';
            UPDATE products  SET suppliers_id=5  WHERE product_name='Queso Cabrales';
            UPDATE products  SET suppliers_id=5  WHERE product_name='Queso Manchego La Pastora';
            UPDATE products  SET suppliers_id=6  WHERE product_name='Konbu';
            UPDATE products  SET suppliers_id=6  WHERE product_name='Tofu';
            UPDATE products  SET suppliers_id=6  WHERE product_name='Genen Shouyu';
            UPDATE products  SET suppliers_id=7  WHERE product_name='Pavlova';
            UPDATE products  SET suppliers_id=7  WHERE product_name='Alice Mutton';
            UPDATE products  SET suppliers_id=7  WHERE product_name='Carnarvon Tigers';
            UPDATE products  SET suppliers_id=7  WHERE product_name='Vegie-spread';
            UPDATE products  SET suppliers_id=7  WHERE product_name='Outback Lager';
            UPDATE products  SET suppliers_id=8  WHERE product_name='Chai';
            UPDATE products  SET suppliers_id=8  WHERE product_name='Teatime Chocolate Biscuits';
            UPDATE products  SET suppliers_id=8  WHERE product_name='Sir Rodney''s Marmalade';
            UPDATE products  SET suppliers_id=8  WHERE product_name='Sir Rodney''s Scones';
            UPDATE products  SET suppliers_id=8  WHERE product_name='Scottish Longbreads';
            UPDATE products  SET suppliers_id=9  WHERE product_name='Gustaf''s Knäckebröd';
            UPDATE products  SET suppliers_id=9  WHERE product_name='Tunnbröd';
            UPDATE products  SET suppliers_id=10  WHERE product_name='Guaraná Fantástica';
            UPDATE products  SET suppliers_id=11  WHERE product_name='NuNuCa Nuß-Nougat-Creme';
            UPDATE products  SET suppliers_id=11  WHERE product_name='Gumbär Gummibärchen';
            UPDATE products  SET suppliers_id=11  WHERE product_name='Schoggi Schokolade';
            UPDATE products  SET suppliers_id=12  WHERE product_name='Rössle Sauerkraut';
            UPDATE products  SET suppliers_id=12  WHERE product_name='Thüringer Rostbratwurst';
            UPDATE products  SET suppliers_id=12  WHERE product_name='Wimmers gute Semmelknödel';
            UPDATE products  SET suppliers_id=12  WHERE product_name='Rhönbräu Klosterbier';
            UPDATE products  SET suppliers_id=12  WHERE product_name='Original Frankfurter grüne Soße';
            UPDATE products  SET suppliers_id=13  WHERE product_name='Nord-Ost Matjeshering';
            UPDATE products  SET suppliers_id=14  WHERE product_name='Gorgonzola Telino';
            UPDATE products  SET suppliers_id=14  WHERE product_name='Mascarpone Fabioli';
            UPDATE products  SET suppliers_id=14  WHERE product_name='Mozzarella di Giovanni';
            UPDATE products  SET suppliers_id=15  WHERE product_name='Geitost';
            UPDATE products  SET suppliers_id=15  WHERE product_name='Gudbrandsdalsost';
            UPDATE products  SET suppliers_id=15  WHERE product_name='Flotemysost';
            UPDATE products  SET suppliers_id=16  WHERE product_name='Sasquatch Ale';
            UPDATE products  SET suppliers_id=16  WHERE product_name='Steeleye Stout';
            UPDATE products  SET suppliers_id=16  WHERE product_name='Laughing Lumberjack Lager';
            UPDATE products  SET suppliers_id=17  WHERE product_name='Inlagd Sill';
            UPDATE products  SET suppliers_id=17  WHERE product_name='Gravad lax';
            UPDATE products  SET suppliers_id=17  WHERE product_name='Röd Kaviar';
            UPDATE products  SET suppliers_id=18  WHERE product_name='Côte de Blaye';
            UPDATE products  SET suppliers_id=18  WHERE product_name='Chartreuse verte';
            UPDATE products  SET suppliers_id=19  WHERE product_name='Boston Crab Meat';
            UPDATE products  SET suppliers_id=19  WHERE product_name='Jack''s New England Clam Chowder';
            UPDATE products  SET suppliers_id=20  WHERE product_name='Singaporean Hokkien Fried Mee';
            UPDATE products  SET suppliers_id=20  WHERE product_name='Ipoh Coffee';
            UPDATE products  SET suppliers_id=20  WHERE product_name='Gula Malacca';
            UPDATE products  SET suppliers_id=21  WHERE product_name='Rogede sild';
            UPDATE products  SET suppliers_id=21  WHERE product_name='Spegesild';
            UPDATE products  SET suppliers_id=22  WHERE product_name='Zaanse koeken';
            UPDATE products  SET suppliers_id=22  WHERE product_name='Chocolade';
            UPDATE products  SET suppliers_id=23  WHERE product_name='Maxilaku';
            UPDATE products  SET suppliers_id=23  WHERE product_name='Valkoinen suklaa';
            UPDATE products  SET suppliers_id=23  WHERE product_name='Lakkalikööri';
            UPDATE products  SET suppliers_id=24  WHERE product_name='Manjimup Dried Apples';
            UPDATE products  SET suppliers_id=24  WHERE product_name='Filo Mix';
            UPDATE products  SET suppliers_id=24  WHERE product_name='Perth Pasties';
            UPDATE products  SET suppliers_id=25  WHERE product_name='Tourtière';
            UPDATE products  SET suppliers_id=25  WHERE product_name='Pâté chinois';
            UPDATE products  SET suppliers_id=26  WHERE product_name='Gnocchi di nonna Alice';
            UPDATE products  SET suppliers_id=26  WHERE product_name='Ravioli Angelo';
            UPDATE products  SET suppliers_id=27  WHERE product_name='Escargots de Bourgogne';
            UPDATE products  SET suppliers_id=28  WHERE product_name='Raclette Courdavault';
            UPDATE products  SET suppliers_id=28  WHERE product_name='Camembert Pierrot';
            UPDATE products  SET suppliers_id=29  WHERE product_name='Sirop d''érable';
            UPDATE products  SET suppliers_id=29  WHERE product_name='Tarte au sucre';
